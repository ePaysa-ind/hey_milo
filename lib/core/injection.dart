...
Future<void> setupDependencyInjection() async {
  try {
    ...
    getIt.registerLazySingleton<LoggingService>(
        ...
        enableFileLogging: !kReleaseMode,
      ),
    );
    ...
    // Comment out services that haven't been implemented yet
    /*
    ...
    */
    ...
    final loggingService = getIt.isRegistered<LoggingService>()
        ? getIt<LoggingService>()
        : LoggingService()..initialize(enableFileLogging: false);

    loggingService.error('Failed to set up dependency injection', e, stackTrace);
